...
import fet.datn.service.OtpRestrictionService;
...
public class OtpServiceImpl implements OtpService {
    ...
    @Autowired
    private OtpRestrictionService otpRestrictionServiceImpl;
    ...
    public OtpEntity generateOtp(OtpGenerationRequest request) {
        ...
        OtpRestrictionEntity blocked = otpRestrictionServiceImpl.findOtpRestrictionByMobile(request.getMobileNumber(), request.getType());
        if (blocked != null) {
    ...
    private String generateOtpCode() {
        ...
        do {
            otpCode = tokenServiceImpl.generateCode(otpConfiguration.getOtpValidCharacter(), otpConfiguration.getOtpLength());
